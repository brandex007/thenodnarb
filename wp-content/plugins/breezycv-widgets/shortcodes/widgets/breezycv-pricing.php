...
class Breezycv_Pricing extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'button_url',
			  [
				 'label'       => __( 'Button URL', 'breezycv-widgets' ),
				 'type'        => Controls_Manager::TEXT,
				 'placeholder' => __( 'Type button URL here', 'breezycv-widgets' ),
		...
		$this->add_control(
			'target',
			[
				'label' => __( 'Open Button URL in New Tab', 'breezycv-widgets' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'breezycv-widgets' ),
				'label_off' => __( 'No', 'breezycv-widgets' ),
				'return_value' => 'yes',
			...
			<div class="fw-package <?php echo esc_attr($highlight); ?>">
		        ...
		        <?php if (! empty($button_text)) { 
			        ...
			        <div class="fw-button-row">
			        	<a href="<?php echo wp_kses_post($button_url); ?>" target="<?php echo esc_attr($target); ?>" class="btn btn-<?php echo esc_attr($button_type); ?>"><?php echo wp_kses_post($button_text); ?></a>
			        </div>
			    <?php } ?>

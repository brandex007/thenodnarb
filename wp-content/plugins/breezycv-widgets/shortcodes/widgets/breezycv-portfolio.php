...
class Breezycv_Portfolio extends Widget_Base {

	public function get_name() {
		return 'breezycv-portfolio';
	}

	public function get_title() {
		return __( 'Portfolio', 'breezycv-widgets' );
	}
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'four-columns' => __( 'Four Columns', 'breezycv-widgets' ),
					'five-columns' => __( 'Five Columns', 'breezycv-widgets' ),
				],
			]
		);
	...
	protected function render() {
		...
		if ( fw_ext('portfolio') && function_exists( 'breezycv_filter_portfolio_extension' ) ) {
		    ...
		    <div id="portfolio_content_<?php echo esc_attr($id); ?>" class="portfolio-content" data-categories="<?php echo esc_attr($categories_selected_string); ?>">
		        ...
		        <?php if ( ! empty( $categories ) ) : ?>
		            <ul class="portfolio-filters">
		                <li class="active">
		                    <a class="filter btn btn-sm btn-link" data-group="category_all"><?php esc_html_e( 'All', 'breezycv-widgets' ); ?></a>
		                </li>
		        ...
		        <!-- Portfolio Grid -->
		        <div class="portfolio-grid <?php echo esc_attr($layout); ?>" data-pages-num="<?php echo esc_attr($max); ?>">
		                        ...
		                        <figure class="item <?php echo esc_attr($portfolio_type); ?>" data-groups='["category_all"<?php fw_theme_portfolio_post_taxonomies_slug(get_the_ID()); ?>]'>
		                            ...
		                            <?php
		                                if ( has_post_thumbnail() ) {
		                                    ...
		                                    ?>
		                                        <img src="<?php echo get_template_directory_uri(); ?>/images/portfolio_no_image.jpg" class="portfolio-without-image" alt="<?php esc_attr_e('image', 'breezycv-widgets'); ?>" />
		                                    <?php
		                                }
		                            ?>

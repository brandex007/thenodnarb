						...
						<div class="entry-content">
		                    <div id="portfolio-page" class="portfolio-page-content">
		                        <div class="portfolio-page-wrapper">
		                            <?php
		                            	if ( function_exists( 'breezycv_theme_portfolio_nav' ) ) {
											breezycv_theme_portfolio_nav();
										}
									?>
			                                        ...
			                                        if ( ! empty( $thumbnails ) ) :
			                                            ...
			                                            <div class="owl-carousel portfolio-page-carousel">
			                                                <?php foreach ( $thumbnails as $thumbnail ) :
			                                                    ...
			                                                    <a href="<?php echo esc_url($image['url']) ?>" class="lightbox">
			                                                    	<img src="<?php echo esc_url($image['url']) ?>" alt="<?php esc_attr_e('image', 'breezycv-portfolio'); ?>"/>
			                                                    </a>
			                                                <?php endforeach ?>
			                                            </div>
			                                            ...
			                                            <div id="portfolio-gallery-grid" class="portfolio-grid <?php echo esc_attr($pf_gallery_grid_columns) ?>">
			                                                <?php foreach ( $thumbnails as $thumbnail ) :
			                                                    ...
			                                                    ?>
			                                                    <figure class="item">
			                                                    	<a href="<?php echo esc_url($image['url']) ?>" class="lightbox"></a>
			                                                    	...
			                                                    	<?php } else { ?>
			                                                    		...
			                                                    		<img src="<?php echo esc_url(fw_resize($image['url'],850,850,true)) ?>" alt="<?php esc_attr_e('image', 'breezycv-portfolio'); ?>"
			                                                    		/>
			                                                    		<?php } elseif ( $pf_gallery_grid_columns == "two-columns" ) { ?>
			                                                    		<img src="<?php echo esc_url(fw_resize($image['url'],600,600,true)) ?>" alt="<?php esc_attr_e('image', 'breezycv-portfolio'); ?>"
			                                                    		/>
			                                                    		<?php } elseif ( $pf_gallery_grid_columns == "three-columns" ) { ?>
			                                                    		<img src="<?php echo esc_url(fw_resize($image['url'],400,400,true)) ?>" alt="<?php esc_attr_e('image', 'breezycv-portfolio'); ?>"
			                                                    		/>
			                                                    		<?php } ?>
			                                ...
			                                <div class="col-sm-12 col-md-4 portfolio-block<?php if ($portfolio_sidebar_position == "left") { ?> order-first mb-4<?php } ?>">
			                                    ...
			                                    <div class="project-description">
				                                    <div class="block-title">
			                                            ...
			                                            <?php } else { ?>
			                                            <h3><?php esc_html_e( 'Description', 'breezycv-portfolio' ); ?></h3>
			                                            <?php } ?>
				                                    </div>
				                                    ...
				                                    ?>
					                                    ...
					                                    <div class="tags-block">
					                                        <div class="block-title">
					                                            ...
					                                            <?php } else { ?>
					                                            <h3><?php esc_html_e( 'Technology', 'breezycv-portfolio' ); ?></h3>
					                                            <?php } ?>
					                                        </div>
					                                        <ul class="tags">
																<?php foreach (fw_get_db_post_option($post->ID, 'portfolio_type/standard/pf_tags', '') as $breezycv_project_tags): ?>

																	   <li><a><?php echo esc_html($breezycv_project_tags); ?></a></li>
													...
													<?php if ( function_exists( 'breezycv_theme_share_buttons' ) && $share_buttons_show == "1" ) : ?>
														<!-- Share Buttons -->
														<div class="share-buttons">
															<div class="block-title">
					                                            ...
					                                            <?php } else { ?>
					                                            <h3><?php esc_html_e( 'Share', 'breezycv-portfolio' ); ?></h3>
					                                            <?php } ?>
															</div>
															<div class="btn-group">

...
function breezycv_portfolio_post_thumbnail_sizes_attr($attr, $attachment, $size) {
...
add_filter('wp_get_attachment_image_attributes', 'breezycv_portfolio_post_thumbnail_sizes_attr', 10 , 3);

/**
 * LMPixels custom taxonomy in the Gutenberg
 */
function breezycv_portfolio_taxonomy_gutenberg() {
    $mytax = get_taxonomy( 'fw-portfolio-category' );
    $mytax->show_in_rest = true;
}

add_action( 'init', 'breezycv_portfolio_taxonomy_gutenberg', 30 );
/* ================================================================================================ */


function breezycv_loadmore_ajax_handler(){
    global $post;
    $layout = $atts['layout'];
...
add_action('wp_ajax_loadmore', 'breezycv_loadmore_ajax_handler');
add_action('wp_ajax_nopriv_loadmore', 'breezycv_loadmore_ajax_handler');